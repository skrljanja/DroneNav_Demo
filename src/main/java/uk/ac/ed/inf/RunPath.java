...
public class RunPath {
    ...
    public boolean run(String DBmachine, String DBport, String webMachine, String webPort, String day, String month, String year) {
        ...
        System.out.println("points visited on " + date + ": " + points.size());
        System.out.println("number of orders placed on " + date + ": " + dailyOrders.size());
        System.out.println("number of orders delivered on " + date + ": " + delivered);
